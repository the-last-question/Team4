...
% -------------------------------------------------------------------------------
% Informações gerais
    \thesistitle{Tecnologia de posicionamento indoor: pozyx.}
    \hidevolume
    \thesisvolume{Volume 1 of 1}
    \thesisauthor{Brenda Silva de Alencar}
    \thesisauthorr{Lucas Lins Souza}
    \thesisauthorrr{Mariana Mota Villas Boas}
    %\thesisauthorrrr{Nathália ?}
...
% Include thesis chapters
    ...
    %\include{Chapters/metodos} %!Não foi utilizado
    %\include{Chapters/resultados}%!Não foi utilizado
...
% Include thesis appendices
    \begin{thesisappendices}
        %\include{Appendices/diagmec}%!Não foi utilizado
        %\include{Appendices/diagele}%!Não foi utilizado
        %\include{Appendices/logbook}%!Não foi utilizado
