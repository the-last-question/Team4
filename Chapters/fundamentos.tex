...
foi utilizada em radares do exército estado-unidense e, entre os anos de 1960 a 1990 ficou restrita aplicações militares.\cite{Lucas4}
...
\begin{figure} [h!]												 
	...
	\caption{Espectro de frequência de algumas tecnologias \textit{Wireless}.\cite{Lucas3}}		
	\label{img:ihuma}												 
\end{figure}
...
eficientes nessas situações, visto que são menos susceptíveis a estas alterações.\cite{Lucas2} 
